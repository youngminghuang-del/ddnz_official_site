...
const HERO_ROUTE_COPY: Record<Language, HeroRouteCopy> = {
  en: {
    ...
    centralAsia: 'Russia & Central Asia',
    ...
    centralAsiaCountries: 'Russia / Kazakhstan / Uzbekistan / Kyrgyzstan / Tajikistan / Turkmenistan',
  ...
  zh: {
    ...
    centralAsiaCountries: '俄罗斯 / 哈萨克斯坦 / 乌兹别克斯坦 / 吉尔吉斯斯坦 / 塔吉克斯坦 / 土库曼斯坦',
    viewRoutes: '查看路线',
  },
  ru: {
    origin: 'Из Китая',
    ...
    centralAsia: 'Россия и Центральная Азия',
    ...
    centralAsiaCountries: 'Россия / Казахстан / Узбекистан / Кыргызстан / Таджикистан / Туркменистан',
    viewRoutes: 'Маршруты',
  },
  fr: {
    origin: 'Départ Chine',
    ...
    centralAsia: 'Russie et Asie centrale',
    ...
    centralAsiaCountries: 'Russie / Kazakhstan / Ouzbékistan / Kirghizistan / Tadjikistan / Turkménistan',
  ...
  es: {
    ...
    centralAsia: 'Rusia y Asia Central',
    ...
    centralAsiaCountries: 'Rusia / Kazajistán / Uzbekistán / Kirguistán / Tayikistán / Turkmenistán',
  ...
  ar: {
    ...
    centralAsia: 'روسيا وآسيا الوسطى',
    ...
    centralAsiaCountries: 'روسيا / كازاخستان / أوزبكستان / قيرغيزستان / طاجيكستان / تركمانستان',
    viewRoutes: 'عرض المسارات',
  },
  pt: {
    origin: 'Origem China', latinAmerica: 'América Latina', middleEast: 'Oriente Médio', westAfrica: 'África Ocidental', centralAsia: 'Rússia e Ásia Central',
    latinCountries: 'México / Brasil / Peru / Chile', middleEastCountries: 'Arábia Saudita / EAU / Catar / Omã / Bahrein', westAfricaCountries: 'Nigéria / Gana / Costa do Marfim / Senegal', centralAsiaCountries: 'Rússia / Cazaquistão / Uzbequistão / Quirguistão / Tajiquistão / Turcomenistão', viewRoutes: 'Ver rotas',
  },
  tr: {
    origin: 'Çin çıkışı', latinAmerica: 'Latin Amerika', middleEast: 'Orta Doğu', westAfrica: 'Batı Afrika', centralAsia: 'Rusya ve Orta Asya',
    latinCountries: 'Meksika / Brezilya / Peru / Şili', middleEastCountries: 'Suudi Arabistan / BAE / Katar / Umman / Bahreyn', westAfricaCountries: 'Nijerya / Gana / Fildişi Sahili / Senegal', centralAsiaCountries: 'Rusya / Kazakistan / Özbekistan / Kırgızistan / Tacikistan / Türkmenistan', viewRoutes: 'Rotaları görüntüle',
  },
};
