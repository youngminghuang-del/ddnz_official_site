...
export default function Partners() {
  ...
  const filteredFaqs = useMemo(() => {
    ...
    return HOME_FAQ_ITEMS.filter((item) => {
      ...
      return `${getLocalizedHomeFaqText(item, 'question', currentLang)} ${getLocalizedHomeFaqText(item, 'answer', currentLang)}`
        .toLocaleLowerCase()
                      ...
                      >
                        <span className="flex min-w-0 items-start gap-4">
                          ...
                          <span className="pt-1 text-sm font-black leading-6 text-[var(--ddnz-ink)] md:text-base">
                            ...
                            {getLocalizedHomeFaqText(item, 'question', currentLang)}
                          </span>
                        </span>
                          ...
                          <div className="border-t border-slate-100 px-5 pb-6 pt-5 md:px-6">
                            <div className="sm:ms-[60px]">
                              <p className="max-w-3xl text-sm font-medium leading-7 text-slate-600">
                                {getLocalizedHomeFaqText(item, 'answer', currentLang)}
                              </p>
                              <Link
                                to={getItemHref(item)}
                              ...
                              >
                                {getLocalizedHomeFaqText(item, 'cta', currentLang)}
