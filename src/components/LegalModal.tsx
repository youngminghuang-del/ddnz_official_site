  ...
  const content = {
    privacy: {
      ...
      sections: [
        ...
        { title: 'Analytics and cookies', text: 'Before you choose or after you decline, Google Analytics uses Advanced Consent Mode and Microsoft Clarity runs in limited no-consent mode. They may receive limited page, consent and interaction signals without analytics cookies; Clarity uses a new identifier for each page view. If you enable analytics, Google Analytics and Microsoft Clarity may use analytics cookies to measure visits across pages and sessions. Targeting consent is separate. We do not send contact-form fields to analytics. You can change or withdraw your choice through Cookie Settings; the providers then receive denied consent metadata, optional cookie storage stops, and limited cookieless measurement continues.' },
