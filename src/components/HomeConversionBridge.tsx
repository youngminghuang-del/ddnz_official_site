...
const COPY: Record<Language, BridgeCopy> = {
  ...
  pt: { eyebrow: 'Escolha a próxima etapa', title: 'Comece com a equipe adequada à fase do pedido.', body: 'Sourcing, pedidos já colocados e solicitações somente de frete precisam de informações diferentes.', sourcing: 'Iniciar brief de sourcing', sourcingDesc: 'Encontrar e coordenar produtos e fornecedores na China.', existing: 'Solicitar inspeção ou consolidação', existingDesc: 'Colocar pedidos existentes sob uma equipe de controle na China.', freight: 'Solicitar cotação de frete', freightDesc: 'Planejar exportação e transporte de mercadorias prontas.', whatsapp: 'Em dúvida? Fale com a equipe pelo WhatsApp', privacy: 'Seus dados são usados somente para avaliar esta solicitação.' },
  tr: { eyebrow: 'Doğru sonraki adımı seçin', title: 'Sipariş aşamanıza uygun ekiple başlayın.', body: 'Ürün tedariği, mevcut siparişler ve sadece nakliye talepleri farklı bilgiler gerektirir.', sourcing: 'Tedarik talebi oluştur', sourcingDesc: 'Çin’de ürün ve tedarikçi bulun ve koordine edin.', existing: 'Denetim veya konsolidasyon iste', existingDesc: 'Mevcut tedarikçi siparişlerini Çin’de tek ekiple yönetin.', freight: 'Nakliye teklifi al', freightDesc: 'Hazır yük için ihracat rotası ve taşıma planlayın.', whatsapp: 'Emin değil misiniz? WhatsApp’tan ekibe sorun', privacy: 'Bilgileriniz yalnızca bu talebi değerlendirmek için kullanılır.' },
};
