...
export const displayPriceDate = '2026-09-24';
...
// Display prices updated 2026-09-24: supplier wholesale column × 1.50.
// Supplier source prices remain recorded in the original PDF and git history.
...
export const machines = [
  { id: 'hw-j15-copper', model: 'HW-J15', name: 'Dough kneader', family: 'dough', variant: 'Copper-core motor · 15 kg model', price: 2205, packing: 40, packingType: 'Wood packing', power: '1.5 kW', dimensions: '520 × 670 × 760 mm', weight: 59, pricePage: 2, catalogPage: 10, image: 'kneader', note: 'Select the copper-core version; the aluminium-core version has a different price.' },
  { id: 'yh-gt300', model: 'YH-GT300', name: 'Tabletop dough roller', family: 'dough', variant: 'Copper motor · steel rollers', price: 1770, packing: 0, packingType: 'Wood frame included', power: '1.5 kW', dimensions: '430 × 480 × 450 mm', weight: 42, pricePage: 1, catalogPage: 9, image: 'dough-roller', note: 'Noodle cutter excluded. Standard 1.5–6 mm flat cutter: CNY 225 each, before tax. Stainless rollers: +CNY 270.' },
  { id: 'h20', model: 'H20', name: 'Spiral dough mixer', family: 'bakery', variant: 'Mechanical speed change', price: 3450, packing: 0, packingType: 'Wood frame included', power: '1.5 kW', dimensions: '750 × 400 × 850 mm', weight: 86, pricePage: 3, catalogPage: 6, image: 'spiral-mixer', note: 'Catalogue height is 860 mm; confirm the production dimensions. H20-B and H20-T are separate variants.' },
  { id: 'b20-guard', model: 'B20', name: 'Planetary mixer', family: 'bakery', variant: 'With bowl guard · three functions', price: 3225, packing: 0, packingType: 'Wood frame included', power: '1.5 kW', dimensions: '550 × 520 × 830 mm', weight: 63, pricePage: 3, catalogPage: 5, image: 'planetary-mixer', note: 'Price is for the guarded version; verify attachments and interlock configuration.' },
  { id: 'q31b', model: 'Q31B', name: 'Bread slicer', family: 'bakery', variant: '31-blade model', price: 3225, packing: 0, packingType: 'Wood frame included', power: '0.25 kW', dimensions: '515 × 625 × 585 mm', weight: 48, pricePage: 3, catalogPage: 11, image: 'bread-slicer', note: 'Match loaf dimensions and slice thickness before ordering.' },
  { id: 'dq-t', model: 'DQ-T', name: 'Tabletop meat slicer', family: 'meat', variant: 'Removable stainless blade set', price: 870, packing: 0, packingType: 'Carton included', power: '0.85 kW', dimensions: '370 × 340 × 350 mm', weight: 20, pricePage: 4, catalogPage: 14, image: 'meat-slicer', note: 'Catalogue weight is 18 kg; price list states 20 kg. Confirm blade spacing and suitable meat condition.' },
  { id: 'jr-gg22', model: 'JR-GG22', name: 'Tabletop meat grinder', family: 'meat', variant: 'All-steel grinding parts · copper motor', price: 1680, packing: 0, packingType: 'Carton included', power: '1.1 kW', dimensions: '410 × 230 × 470 mm', weight: 20, pricePage: 5, catalogPage: 12, image: 'meat-grinder', note: 'Sausage nozzle listed as included. JR-G22 is a different configuration.' },
  { id: 'dj-h18', model: 'DJ-H18', name: 'Meat paste mixer', family: 'meat', variant: 'Tilting double-bowl construction', price: 1305, packing: 40, packingType: 'Wood packing', power: '1.5 kW', dimensions: '480 × 420 × 770 mm', weight: 31, pricePage: 7, catalogPage: 22, image: 'paste-mixer', note: 'Batch size and mixing time need to be matched to the recipe.' },
  { id: 'cx-l', model: 'CX-L', name: 'Meatball former', family: 'meat', variant: 'Standing model · four mould sets', price: 3840, packing: 0, packingType: 'Wood frame included', power: '1.1 kW', dimensions: '700 × 390 × 1220 mm', weight: 65, pricePage: 7, catalogPage: 22, image: 'meatball-former', note: 'Standard version; variable-speed CX-LB is priced separately.' },
  { id: 'tp-350', model: 'TP-350', name: 'Potato peeler', family: 'vegetables', variant: 'Abrasive peeling drum', price: 1800, packing: 50, packingType: 'Wood packing', power: '1.1 kW', dimensions: '660 × 410 × 830 mm', weight: 50, pricePage: 6, catalogPage: 25, image: 'potato-peeler', note: 'Catalogue length is 680 mm; price list states 660 mm. Confirm water and drainage connections.' },
  { id: 'dq-ps300-copper', model: 'DQ-PS300', name: 'Vegetable slicer & shredder', family: 'vegetables', variant: 'Copper-core motor · one-way blade', price: 1725, packing: 0, packingType: 'Wood frame included', power: '1.1 kW', dimensions: '400 × 360 × 750 mm', weight: 34, pricePage: 6, catalogPage: 27, image: 'vegetable-slicer', note: 'Confirm blade set and cut sizes. This is the copper-core version.' },
  { id: 'sc-r22', model: 'SC-R22', name: 'Vegetable chopper', family: 'vegetables', variant: 'Steel shaft & blade', price: 570, packing: 0, packingType: 'Carton included', power: '0.55 kW', dimensions: '320 × 230 × 480 mm', weight: 9, pricePage: 6, catalogPage: 27, image: 'chopper', note: 'Confirm batch size and cutting result using your ingredients.' },
  { id: 'mj-d100', model: 'MJ-D100', name: 'Pulp separator', family: 'grain', variant: 'Copper motor · cast-aluminium housing', price: 975, packing: 0, packingType: 'Carton included', power: '1.1 kW', dimensions: '270 × 320 × 630 mm', weight: 20, pricePage: 6, catalogPage: 23, image: 'pulp-separator', note: 'Catalogue dimensions differ (250 × 460 × 610 mm). Confirm model revision before space planning.' },
  { id: 'mj-h12', model: 'MJ-H12', name: 'Wet rice grinder', family: 'grain', variant: 'Copper motor · steel base', price: 1170, packing: 0, packingType: 'Wood frame included', power: '0.75 kW', dimensions: '240 × 460 × 700 mm', weight: 28, pricePage: 6, catalogPage: 24, image: 'rice-grinder', note: 'Confirm ingredient preparation, fineness and cleaning procedure.' },
  { id: 'gz-tc', model: 'GZ-TC', name: 'Sugarcane juicer', family: 'grain', variant: 'Mains-powered tabletop model', price: 2055, packing: 0, packingType: 'Wood frame included', power: '0.35 kW', dimensions: '380 × 275 × 540 mm', weight: 31, pricePage: 7, catalogPage: 31, image: 'sugarcane-juicer', note: 'GZ-TD battery and GZ-TS dual-power models are different configurations.' },
  { id: 'tm-hl', model: 'TM-HL', name: 'Poultry plucker', family: 'poultry', variant: 'All-steel large model · copper motor', price: 2070, packing: 45, packingType: 'Wood packing', power: '1.5 kW', dimensions: '605 × 605 × 950 mm', weight: 57, pricePage: 7, catalogPage: 30, image: 'poultry-plucker', note: 'Confirm bird type, preparation process and replacement finger sizes.' },
];
export const packages = [
  { id: 'noodles', title: 'Noodle & dough preparation', description: 'Knead dough and roll sheets for fresh noodle preparation.', steps: ['Knead', 'Roll', 'Cut with optional cutter'], items: ['hw-j15-copper','yh-gt300'], extra: 'Add a matching noodle cutter (standard flat cutter: CNY 225, before tax). Cooking equipment is separate.' },
