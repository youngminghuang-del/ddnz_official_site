...
export default function MobileSourcingPage(){
 const {pathname}=useLocation(),page=mobilePageForPath(pathname)||{id:'hub',path:'/sourcing/mobile-accessories-from-china'},locale=productRouteParts(pathname).locale as 'en' | 'es' | 'ar';
