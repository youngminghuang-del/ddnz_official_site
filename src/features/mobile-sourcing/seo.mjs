...
export function mobileMetadata(id,locale='en'){
 ...
 {'@type':'BreadcrumbList',itemListElement:[{name:copyFor(ui.home,locale),item:base+(locale==='en'?'/':`/${locale}/`)},{name:copyFor(ui.hub,locale),item:base+localizedProductPath('/sourcing/mobile-accessories-from-china',locale)},...(id==='hub'?[]:[{name:copyFor(ui[id],locale),item:base+path}])].map((x,i)=>({'@type':'ListItem',position:i+1,...x}))},
 ]};
