...
import { articleRoutePath } from '../../lib/notionArticleRouting';
const publishedArticlePaths = new Set(notionBlogPosts.map(post => articleRoutePath(post).replace(/\/$/, '')));
