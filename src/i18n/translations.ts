...
export const translations = {
  en: {
    nav: {
      ...
      shipping_by_region: 'SHIPPING BY REGION',
      region_middle_east: 'Middle East Hubs',
      region_central_asia: 'Central Asia Gateway',
      region_west_africa: 'West Africa Route',
      region_latin_america: 'Latin America Network',
      insights: 'INSIGHTS',
  ...
  ru: {
    nav: {
      ...
      shipping_by_region: 'ДОСТАВКА ПО РЕГИОНАМ',
      region_middle_east: 'Хабы Ближнего Востока',
      region_central_asia: 'Шлюз Центральной Азии',
      region_west_africa: 'Западноафриканский маршрут',
      region_latin_america: 'Сеть Латинской Америки',
      insights: 'РЕСУРСЫ',
    ...
    routes: {
      centralAsia: {
        metaTitle: "Доставка из Китая в Россию и Центральную Азию | DDNZ",
        metaDescription: "Железнодорожные, автомобильные, мультимодальные и авиаперевозки из Китая в Россию и пять стран Центральной Азии с проверкой маршрута и документов.",
        heroHeadline: "Доставка из Китая в Россию и Центральную Азию",
        heroSubheadline: "Сравните рабочие коридоры для России, Казахстана, Узбекистана, Кыргызстана, Таджикистана и Туркменистана. Маршрут, граница и объем доставки подтверждаются письменно.",
  ...
  fr: {
    nav: {
      ...
      shipping_by_region: 'EXPÉDITION PAR RÉGION',
      region_middle_east: 'Hubs du Moyen-Orient',
      region_central_asia: 'Porte d\'Asie Centrale',
      region_west_africa: 'Route d\'Afrique de l\'Ouest',
      region_latin_america: 'Réseau d\'Amérique Latine',
      insights: 'INSIGHTS',
  ...
  zh: {
    nav: {
      ...
      shipping_by_region: '按区域运输',
      region_middle_east: '中东大市场',
      region_central_asia: '中亚专线枢纽',
      region_west_africa: '西非直航路线',
      region_latin_america: '中南美洲庄家网络',
      insights: '行业洞察',
      get_a_quote: '获取报价',
    },
    hero: {
...
Object.assign(localizedTranslations.es, {
  ...
  insights: {
    ...
    showAll: 'Ver todas las categorías', deep_dive_read: 'Leer artículo', read_time: '4 min', no_articles: 'No se encontraron artículos', no_articles_desc: 'Aún no hay publicaciones para esta categoría.',
  },
...
Object.assign(localizedTranslations.ar, {
  ...
  insights: {
    ...
    showAll: 'عرض جميع الفئات', deep_dive_read: 'اقرأ المقال', read_time: '4 دقائق', no_articles: 'لا توجد مقالات', no_articles_desc: 'لا توجد منشورات لهذه الفئة حتى الآن.',
  },
...
localizedTranslations.pt = {
  ...
  insights: {
    ...
    showAll: 'Todas as categorias', deep_dive_read: 'Ler artigo', read_time: '4 min', no_articles: 'Nenhum artigo encontrado', no_articles_desc: 'Ainda não há publicações nesta categoria.',
  },
...
localizedTranslations.tr = {
  ...
  insights: {
    ...
    showAll: 'Tüm kategoriler', deep_dive_read: 'Makaleyi oku', read_time: '4 dk', no_articles: 'Makale bulunamadı', no_articles_desc: 'Bu kategoride henüz yayın yok.',
  },
