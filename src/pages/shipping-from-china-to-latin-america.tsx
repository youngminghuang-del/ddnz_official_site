...
const LATAM_DATA = {
  ...
  brazil: {
    en: {
      ...
      seoDesc: "Direct LCL & FCL ocean container shipping from China to Santos, Brazil. Reliable DDP logistics with expert CNPJ verification and SISCOS compliance.",
  ...
  argentina: {
    en: {
      ...
      seoDesc: "Direct ocean and air freight shipping from China to Buenos Aires. Overcome exchange controls and custom barriers with DDNZ offshore escrow gateway.",
