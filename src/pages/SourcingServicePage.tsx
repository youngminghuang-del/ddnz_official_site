...
const serviceCopy: Record<SourcingServiceKind, Record<Language, ServiceCopy>> = {
  'supplier-search': {
    ...
    pt: { eyebrow: 'Busca e comparação de fornecedores', title: 'Compare fornecedores chineses com um único brief de compra.', intro: 'A DDNZ estrutura as referências e exigências do mercado, busca fabricantes e normaliza as cotações antes da escolha de amostras ou auditorias.', useTitle: 'Use este serviço quando', useCases: ['Você tem uma foto ou modelo, mas não uma fábrica verificada.', 'As cotações usam especificações ou itens diferentes.', 'Você precisa de uma lista curta antes de amostras, auditoria ou negociação.'], outputTitle: 'O que você recebe', outputs: ['Brief claro de produto e mercado.', 'Matriz comparável de fornecedores e cotações.', 'Perguntas abertas, lacunas e próximos controles.'], sequenceTitle: 'Do brief à lista curta', sequence: [{ title: 'Definir', body: 'Confirmar uso, destino, especificação, quantidade, orçamento e prazo.' }, { title: 'Buscar', body: 'Identificar fabricantes e verificar identidade e adequação básica.' }, { title: 'Normalizar', body: 'Alinhar modelos, materiais, acessórios, termos e embalagem.' }, { title: 'Recomendar', body: 'Apresentar a lista e prioridades de amostra ou auditoria.' }], boundaryTitle: 'O que a lista não comprova', boundary: 'A lista curta não substitui auditoria de fábrica, aprovação de amostra, análise de conformidade do modelo ou inspeção antes do embarque.', cta: 'Iniciar busca de fornecedores' },
    tr: { eyebrow: 'Tedarikçi arama ve karşılaştırma', title: 'Çin tedarikçilerini tek bir karşılaştırılabilir talebe göre değerlendirin.', intro: 'DDNZ ürün referanslarını ve pazar gerekliliklerini yapılandırır, uygun üreticileri arar ve numune veya denetim kararından önce teklifleri normalize eder.', useTitle: 'Bu hizmeti ne zaman kullanmalı', useCases: ['Ürün fotoğrafınız veya hedef modeliniz var ancak doğrulanmış fabrikanız yok.', 'Tedarikçi tekliflerinde özellikler veya dahil olanlar farklı.', 'Numune, denetim veya pazarlık öncesi kısa liste gerekiyor.'], outputTitle: 'Neler alırsınız', outputs: ['Netleştirilmiş ürün ve pazar talebi.', 'Karşılaştırılabilir tedarikçi ve teklif matrisi.', 'Açık sorular, kanıt açıkları ve sonraki kontroller.'], sequenceTitle: 'Talepten kısa listeye', sequence: [{ title: 'Tanımla', body: 'Kullanım, varış, özellik, miktar, bütçe ve zamanı onayla.' }, { title: 'Ara', body: 'Üreticileri belirle ve temel kimlik ile ürün uygunluğunu kontrol et.' }, { title: 'Normalize et', body: 'Fiyat öncesi model, malzeme, aksesuar, şart ve ambalajı hizala.' }, { title: 'Öner', body: 'Kısa listeyi ve numune veya denetim önceliklerini sun.' }], boundaryTitle: 'Kısa listenin sınırı', boundary: 'Kısa liste; fabrika denetimi, numune onayı, model düzeyi uygunluk incelemesi veya sevkiyat öncesi denetimin yerine geçmez.', cta: 'Tedarikçi arama talebi başlat' },
  },
  'inspection-quality-control': {
    ...
    pt: { eyebrow: 'Inspeção e controle de qualidade', title: 'Inspecione o produto acordado—não uma amostra genérica.', intro: 'A DDNZ transforma especificações aprovadas em checklist, coordena verificações no local e devolve evidências rastreáveis antes da liberação.', useTitle: 'Use este serviço quando', useCases: ['A produção está pronta ou quase pronta.', 'Você precisa de evidências ligadas ao modelo ou amostra aprovada.', 'Etiquetas, acessórios, funções ou embalagem precisam ser verificados.'], outputTitle: 'O que você recebe', outputs: ['Checklist específico do pedido.', 'Fotos e resultados ligados ao modelo e quantidade.', 'Resumo de liberação, retrabalho ou decisão do comprador.'], sequenceTitle: 'Da aprovação às evidências', sequence: [{ title: 'Fixar o escopo', body: 'Confirmar modelo, amostra, quantidades e critérios.' }, { title: 'Preparar', body: 'Criar o checklist e confirmar prontidão e condições de teste.' }, { title: 'Inspecionar', body: 'Verificar identidade, aparência, função, acessórios, etiquetas e embalagem.' }, { title: 'Reportar', body: 'Entregar resultados, fotos, exceções e decisões abertas.' }], boundaryTitle: 'A inspeção tem escopo definido', boundary: 'A inspeção registra o observado no checklist e condições disponíveis. Não é certificação de laboratório, aprovação regulatória ou garantia de cada unidade.', cta: 'Iniciar brief de inspeção' },
    tr: { eyebrow: 'Denetim ve kalite kontrol', title: 'Genel fabrika numunesini değil, kararlaştırılan ürünü denetleyin.', intro: 'DDNZ onaylı özellikleri kontrol listesine dönüştürür, yerinde kontrolleri koordine eder ve serbest bırakmadan önce izlenebilir kanıtları sunar.', useTitle: 'Bu hizmeti ne zaman kullanmalı', useCases: ['Üretim tamamlandı veya tamamlanmak üzere.', 'Onaylı model veya numuneye bağlı kanıt gerekiyor.', 'Etiket, aksesuar, işlev veya ambalaj kontrol edilmeli.'], outputTitle: 'Neler alırsınız', outputs: ['Siparişe özel denetim listesi.', 'Denetlenen model ve miktara bağlı fotoğraf ve bulgular.', 'Serbest bırakma, düzeltme veya alıcı kararı özeti.'], sequenceTitle: 'Onaydan kanıta', sequence: [{ title: 'Kapsamı sabitle', body: 'Model, numune, miktar ve kabul noktalarını doğrula.' }, { title: 'Hazırla', body: 'Kontrol listesini oluştur ve hazır olma ile test koşullarını doğrula.' }, { title: 'Denetle', body: 'Kimlik, görünüm, işlev, aksesuar, etiket ve ambalajı kontrol et.' }, { title: 'Raporla', body: 'Bulguları, fotoğrafları, istisnaları ve açık kararları sun.' }], boundaryTitle: 'Denetimin tanımlı kapsamı vardır', boundary: 'Denetim, kararlaştırılan liste ve mevcut koşullarda gözleneni kaydeder. Laboratuvar sertifikası, mevzuat onayı veya her birim garantisi değildir.', cta: 'Denetim talebi başlat' },
  },
  'consolidation-export': {
    ...
    pt: { eyebrow: 'Consolidação e exportação', title: 'Reúna pedidos aprovados em uma entrega de exportação controlada.', intro: 'A DDNZ coordena prontidão dos fornecedores, recebimento, contagem, embalagem, conciliação e entrega à Heaven Born quando o frete internacional está incluído.', useTitle: 'Use este serviço quando', useCases: ['Pedidos de vários fornecedores precisam seguir juntos.', 'Caixas, quantidades e documentos precisam ser conciliados.', 'Uma equipe na China deve coordenar a prontidão para exportação.'], outputTitle: 'O que você recebe', outputs: ['Registro de prontidão e recebimento.', 'Conciliação de caixas, quantidades e documentos.', 'Entrega ao frete com exceções visíveis.'], sequenceTitle: 'Da liberação do fornecedor à exportação', sequence: [{ title: 'Planejar', body: 'Confirmar fornecedores, pedidos, dados da carga e controles.' }, { title: 'Receber', body: 'Coordenar entrega, contar caixas e registrar a condição.' }, { title: 'Conciliar', body: 'Comparar pedidos, listas, marcas, quantidades e documentos.' }, { title: 'Entregar', body: 'Liberar a carga aprovada para reserva, carregamento e exportação.' }], boundaryTitle: 'Duas funções responsáveis', boundary: 'A DDNZ coordena sourcing, fornecedores, recebimento e registros. A Heaven Born executa o frete internacional quando incluído.', cta: 'Iniciar brief de consolidação' },
    tr: { eyebrow: 'Konsolidasyon ve ihracat', title: 'Onaylı siparişleri tek kontrollü ihracat tesliminde birleştirin.', intro: 'DDNZ tedarikçi hazırlığını, teslim almayı, sayım ve ambalaj kontrollerini, sevkiyat uzlaştırmasını ve kapsamdaysa Heaven Born teslimini koordine eder.', useTitle: 'Bu hizmeti ne zaman kullanmalı', useCases: ['Birden fazla tedarikçinin siparişleri tek sevkiyatta birleşmeli.', 'Rezervasyon öncesi koli, miktar ve belgeler uzlaştırılmalı.', 'İhracat hazırlığını Çin’de tek ekip koordine etmeli.'], outputTitle: 'Neler alırsınız', outputs: ['Tedarikçi hazırlık ve teslim alma kaydı.', 'Konsolide koli, miktar ve belge uzlaştırması.', 'Açık istisnalarla tanımlı nakliye teslimi.'], sequenceTitle: 'Tedarikçi serbest bırakmadan ihracata', sequence: [{ title: 'Planla', body: 'Tedarikçileri, sipariş durumunu, yük verisini ve kontrolleri onayla.' }, { title: 'Teslim al', body: 'Teslimatı koordine et, kolileri say ve görünür durumu kaydet.' }, { title: 'Uzlaştır', body: 'Sipariş, çeki listesi, koli işareti, miktar ve belgeleri eşleştir.' }, { title: 'Teslim et', body: 'Onaylı yükü rezervasyon, yükleme ve ihracat için serbest bırak.' }], boundaryTitle: 'İki sorumlu rol', boundary: 'DDNZ tedarik, takip, teslim alma ve ticari kayıtları koordine eder. Uluslararası nakliye kapsamdaysa Heaven Born tarafından uygulanır.', cta: 'Konsolidasyon talebi başlat' },
  },
};
